...
using DataEntrySystemDL.Clouds;
...
corsBuilder.WithOrigins("http://34.80.69.96:8085"); // Đây là Url bên frontEnd
//corsBuilder.WithOrigins("https://tsmms.tw"); // Đây là Url bên frontEnd
//corsBuilder.WithOrigins("https://tsmms.tw", "https://tn.tsmms.tw"); // Đây là Url bên frontEnd
...
builder.Services.AddScoped<IData_rows_eavService, Data_rows_eavService>();
builder.Services.AddScoped<IData_values_eavService, Data_values_eavService>();
